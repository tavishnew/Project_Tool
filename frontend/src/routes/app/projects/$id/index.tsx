    ...
    <>
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Link to="/app/projects" className="text-sm text-muted-foreground hover:text-foreground">Projects</Link>
          <span className="text-muted-foreground/40">/</span>
          <span className="text-sm font-semibold">Board</span>
        </div>
        <div className="flex gap-2">
          <Link to={`/app/projects/$id/list`} params={{ id }} className="text-sm text-muted-foreground hover:text-foreground">List</Link>
          <Link to={`/app/projects/$id/settings`} params={{ id }} className="text-sm text-muted-foreground hover:text-foreground">Settings</Link>
        </div>
      </div>
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-2">
              <AnimatePresence initial={false}>
                {items.map((t) => (
                  <TaskCard key={t.id} task={t} onOpen={() => setOpenTask(t)} onDragStart={onDragStart} members={members} />
                ))}
              </AnimatePresence>
